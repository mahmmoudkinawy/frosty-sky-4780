...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/frosty-sky-4780)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/frosty-sky-4780
```

A live public deployment of this template is available at [https://frosty-sky-4780.templates.workers.dev](https://frosty-sky-4780.templates.workers.dev)
